...
namespace AzureBlobStorageRESTAPIOperation
{
    ...
    /// Refered URL https://docs.microsoft.com/en-us/rest/api/storageservices/authorize-with-shared-key#blob-queue-and-file-services-shared-key-authorization
    /// </summary>
    internal static class AzureBlobStorageRESTAPIOperation
    {
           ...
           HttpRequestMessage httpRequestMessage, string ifMatch = "", string md5 = "")
        {
            ...
            String MessageSignature = String.Format("{0}\n\n\n{1}\n{5}\n\n\n\n{2}\n\n\n\n{3}{4}",
                      method.ToString(),
                      (method == HttpMethod.Get || method == HttpMethod.Delete) ? String.Empty
